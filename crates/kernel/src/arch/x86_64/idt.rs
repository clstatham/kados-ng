...
pub static IDT: Lazy<InterruptDescriptorTable> = Lazy::new(|| {
    ...
    unsafe {
        idt.divide_error
            .set_handler_addr(x86_64::VirtAddr::new(divide_error_handler as u64));
        idt.debug
            .set_handler_addr(x86_64::VirtAddr::new(debug_handler as u64));
        idt.non_maskable_interrupt
            .set_handler_addr(x86_64::VirtAddr::new(nmi_handler as u64));
        idt.breakpoint
            .set_handler_addr(x86_64::VirtAddr::new(breakpoint_handler as u64));
        idt.overflow
            .set_handler_addr(x86_64::VirtAddr::new(overflow_handler as u64));
        idt.bound_range_exceeded
            .set_handler_addr(x86_64::VirtAddr::new(bound_range_exceeded_handler as u64));
        idt.invalid_opcode
            .set_handler_addr(x86_64::VirtAddr::new(invalid_opcode_handler as u64));
        ...
        idt.invalid_tss
            .set_handler_addr(x86_64::VirtAddr::new(invalid_tss_handler as u64));
        ...
        idt.page_fault
            .set_handler_addr(x86_64::VirtAddr::new(page_fault_handler as u64));
        // reserved: 0x0F
        idt.x87_floating_point
            .set_handler_addr(x86_64::VirtAddr::new(x87_floating_point_handler as u64));
        idt.alignment_check
            .set_handler_addr(x86_64::VirtAddr::new(alignment_check_handler as u64));
        idt.machine_check
            .set_handler_addr(x86_64::VirtAddr::new(machine_check_handler as u64));
        idt.simd_floating_point
            .set_handler_addr(x86_64::VirtAddr::new(simd_floating_point_handler as u64));
        idt.virtualization
            .set_handler_addr(x86_64::VirtAddr::new(virtualization_handler as u64));
        // reserved: 0x15 - 0x1C
        idt.vmm_communication_exception
            .set_handler_addr(x86_64::VirtAddr::new(
                vmm_communication_exception_handler as u64,
            ));
